...
# This class is a page we're redirected to when clicking "Temperature" within Metric conversion main page
...
class TemperatureConversionPage(BaseConversionTypePage):

    def __init__(self, driver):
        super(TemperatureConversionPage, self).__init__(driver)
